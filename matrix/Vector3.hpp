...
class Vector3 : public Vector<Type, 3> {
 public:
  ...
  Vector3 cross(const Matrix31& b) const {
    ...
    return {a(1) * b(2, 0) - a(2) * b(1, 0), -a(0) * b(2, 0) + a(2) * b(0, 0),
            a(0) * b(1, 0) - a(1) * b(0, 0)};
  }
  ...
  inline Vector3 operator-() const { return Matrix31::operator-(); }
  ...
  inline Vector3 operator%(const Matrix31& b) const { return (*this).cross(b); }

  ConstSlice<Type, 2, 1, 3, 1> xy() const { return {0, 0, this}; }

  Slice<Type, 2, 1, 3, 1> xy() { return {0, 0, this}; }
