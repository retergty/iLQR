 ...
 *
 * An instance of this class defines a rotation from coordinate frame 1 to
 * coordinate frame 2. It follows the convention of a 3-2-1 intrinsic Tait-Bryan
 * rotation sequence. In order to go from frame 1 to frame 2 we apply the
 * following rotations consecutively. 1) We rotate about our initial Z axis by
 * an angle of _psi. 2) We rotate about the newly created Y' axis by an angle of
 * _theta. 3) We rotate about the newly created X'' axis by an angle of _phi.
 *
