...
class Scalar {
 public:
  ...
  Scalar(const Matrix<Type, 1, 1>& other) : _value{other(0, 0)} {}

  Scalar(Type other) : _value(other) {}

  operator const Type&() { return _value; }
  ...
  bool operator==(const float other) const { return isEqualF(_value, other); }
